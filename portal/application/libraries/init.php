...
require_once("lib/smartui/UI.php");
require_once("lib/smartui/Util.php");

// smart UI plugins
require_once("lib/smartui/Components/Accordion.php");
require_once("lib/smartui/Components/Button.php");
require_once("lib/smartui/Components/Carousel.php");
require_once("lib/smartui/Components/Datatable.php");
require_once("lib/smartui/Components/Info.php");
require_once("lib/smartui/Components/Nav.php");
require_once("lib/smartui/Components/SmartForm.php");
require_once("lib/smartui/Components/Tab.php");
