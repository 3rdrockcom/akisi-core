...
#$this->load->library('lib/common/util');
#include(BASE_URL.'mloc/application/libraries/lib/common/Util.php');
#echo $_SERVER['DOCUMENT_ROOT'];
include(APPPATH.'libraries/lib/common/Util.php');
//configure constants
...
// global functions
require_once(APPPATH."libraries/lib/func.php");
require_once(APPPATH.'libraries/lib/config.php');

require_once(APPPATH."libraries/lib/smartui/UI.php");
require_once(APPPATH."libraries/lib/smartui/Util.php");

// smart UI plugins
require_once(APPPATH."libraries/lib/smartui/Components/Accordion.php");
require_once(APPPATH."libraries/lib/smartui/Components/Button.php");
require_once(APPPATH."libraries/lib/smartui/Components/Carousel.php");
require_once(APPPATH."libraries/lib/smartui/Components/DataTable.php");
require_once(APPPATH."libraries/lib/smartui/Components/Info.php");
require_once(APPPATH."libraries/lib/smartui/Components/Nav.php");
require_once(APPPATH."libraries/lib/smartui/Components/SmartForm.php");
require_once(APPPATH."libraries/lib/smartui/Components/Tab.php");
