...
function site_enryption(opt,b){
var return_val;

$.ajax({
	    url: $("#bodyurl").attr("siteenc"),
	    data: {
	        enc: opt
	    },
	    type: "POST",
	    ...
	    success: function(msg){
			//console.log(msg.decode,b);
	    	loadURL(msg.decode,b);
	    }
    });
}
...
function checkURL() {
	...
	if (container = $("#content"), e) {
		...
		document.title = a || document.title, debugState && root.console.log("Page title: %c " + document.title, debugStyle_green), site_enryption(e + location.search, container)//loadURL(a + location.search, container)
	} else {
...
function drawBreadCrumb(e) {
	...
	//alert(bread_crumb.find("li:last-child").text());
}
...
var calc_navbar_height = function () {
	...
	initApp = function (e) {
		return e.addDeviceType = function () {
			...
			var e = {
				...
				resetWidgets: function (e) {
					$.SmartMessageBox({
						...
						content: e.data("reset-msg") || "Would you like to refresh this page?",
						buttons: "[No][Yes]"
					}, function (e) {
			...
			}), $.root_.on("click", '[data-action="refreshContent"]', function(b) {
				checkURL();
			...
			$("#search-mobile").click(function () {
				...
				var e = $(this);
				url = e.attr("id"), container = $(".ajax-notifications"), site_enryption(url, container),/**loadURL(url, container)*/ e = null
